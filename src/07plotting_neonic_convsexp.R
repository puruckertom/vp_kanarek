...
control_prepost <- tdarray_control[c(40, 90),1,1:Nsims] #random timestamp pre pesticide application date
level1_prepost <- tdarray_level1[c(40, 90),1,1:Nsims] #random timestamp pre pesticide application date
level3_prepost <- tdarray_level3[c(40, 90),1,1:Nsims] #random timestamp pre pesticide application date
level2_prepost <- tdarray_level2[c(40, 90),1,1:Nsims] #random timestamp pre pesticide application date
...
out_control_colsize <- tdarray_control[40:90,1,1:Nsims]
out_level1_colsize <- tdarray_level1[40:90,1,1:Nsims]
out_level3_colsize <- tdarray_level3[40:90,1,1:Nsims]
out_level2_colsize <- tdarray_level2[40:90,1,1:Nsims]
