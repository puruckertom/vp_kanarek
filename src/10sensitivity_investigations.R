...
#day 50 is 4 days after first application
p.qvf <- p.qvf + geom_jitter(aes(colour=tdarray_control[50,1,])) + 
...
#day 50 is 4 days after first application
p.qvf1 <- p.qvf1 + geom_jitter(aes(colour=tdarray_level1[50,1,])) + 
...
#day 50 is 4 days after first application
p.qvf2 <- p.qvf2 + geom_jitter(aes(colour=tdarray_level2[50,1,])) + 
...
#day 50 is 4 days after first application
p.qvf3 <- p.qvf3 + geom_jitter(aes(colour=tdarray_level3[50,1,])) + 
...
#day 50 is 4 days after first application
p.qvf4 <- p.qvf4 + geom_jitter(aes(colour=tdarray_level4[50,1,])) + 
...
# p.pvn <- p.pvn + geom_jitter(aes(colour=tdarray_control[91,1,])) + 
